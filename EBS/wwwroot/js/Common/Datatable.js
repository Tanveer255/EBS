...
if (document.getElementById("export-table") && typeof simpleDatatables.DataTable !== 'undefined') {
    ...
    //    nextPrev: true,// set the number of rows per page
    //    perPageSelect: [5, 10, 20, 50],
    //    sortable: true,// set the number of rows per page options
    ...
    const table = new simpleDatatables.DataTable("#export-table", {
        template: (options, dom) => "<div class='" + options.classes.top + "'>" +
            "<div class='flex flex-col justify-between sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-3 rtl:space-x-reverse w-full sm:w-auto'>" +
            ...
            "</svg>" +
            "</button>" +
            "<div id='exportDropdown' class='z-10 absolute hidden w-52 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700' data-popper-placement='bottom'>" +
    ...
    $exportButton.addEventListener('click', () => {
        $exportDropdownEl.classList.toggle('hidden');
    });
